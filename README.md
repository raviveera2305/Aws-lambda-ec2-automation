...
Automatically analyzing and categorizing user reviews using AWS Lambda, Python Boto3, and Amazon Comprehend.

==========================================================

📌 Project Overview

This project demonstrates a serverless sentiment analysis solution using AWS Lambda, Boto3, and Amazon Comprehend.
...
The solution can identify the following sentiment categories:
